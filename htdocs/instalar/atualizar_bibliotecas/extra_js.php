...
$endereco_de_pasta_funcoes_jquerys = $pasta_plugins_extras; // endereço de pasta de funcoes
...
func_salvar_arquivo($arquivos_sistema[4], $conteudo_arquivo_jquery); // salvando arquivo
