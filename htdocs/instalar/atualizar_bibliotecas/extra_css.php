...
$endereco_de_pasta_funcoes_css = $pasta_plugins_extras; // endereço de pasta de funcoes
...
func_salvar_arquivo($arquivos_sistema[3], $conteudo_arquivo_css); // salvando arquivo
